...
Version  : 9
Release  : 301
URL      : file:///aot/build/clearlinux/packages/clr-avx-tools/clr-avx-tools-v9.tar.gz
Source0  : file:///aot/build/clearlinux/packages/clr-avx-tools/clr-avx-tools-v9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629264654
