...
Version  : 1
Release  : 1
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v1.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530304241
mkdir clr-build
pushd clr-build
