...
Version  : 113.3
Release  : 420
URL      : file:///aot/build/clearlinux/packages/clr-avx-tools/clr-avx-tools-v113.3.tar.gz
Source0  : file:///aot/build/clearlinux/packages/clr-avx-tools/clr-avx-tools-v113.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654852795
export AR=gcc-ar
