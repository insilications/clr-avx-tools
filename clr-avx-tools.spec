...
Version  : 114.0
Release  : 421
URL      : file:///aot/build/clearlinux/packages/clr-avx-tools/clr-avx-tools-v114.0.tar.gz
Source0  : file:///aot/build/clearlinux/packages/clr-avx-tools/clr-avx-tools-v114.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656034385
## altflags1 content
