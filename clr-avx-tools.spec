...
Version  : 160.0
Release  : 423
URL      : file:///aot/build/clearlinux/packages/clr-avx-tools/clr-avx-tools-v160.0.tar.gz
Source0  : file:///aot/build/clearlinux/packages/clr-avx-tools/clr-avx-tools-v160.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656815541
## altflags1 content
