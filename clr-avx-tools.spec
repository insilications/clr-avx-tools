...
Version  : 150.0
Release  : 422
URL      : file:///aot/build/clearlinux/packages/clr-avx-tools/clr-avx-tools-v150.0.tar.gz
Source0  : file:///aot/build/clearlinux/packages/clr-avx-tools/clr-avx-tools-v150.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656319865
## altflags1 content
