...
Version  : 8
Release  : 10
URL      : https://github.com/clearlinux/clr-avx-tools/archive/v8/clr-avx-tools-8.tar.gz
Source0  : https://github.com/clearlinux/clr-avx-tools/archive/v8/clr-avx-tools-8.tar.gz
...
%prep
%setup -q -n clr-avx-tools-8
cd %{_builddir}/clr-avx-tools-8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592851448
...
cp %{_builddir}/clr-avx-tools-8/COPYING %{buildroot}/usr/share/package-licenses/clr-avx-tools/04319952ed7b0f3b3a70ae4d5d9f954317b8f970
%make_install
